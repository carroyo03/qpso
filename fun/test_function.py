...
if __name__ == '__main__':
    ...
    pyswarm_results = pyswarm_pso_optimize(func = fx.ackley, bounds=bounds, n_particles=n_particles, iters=iters)
    pyswarm_pso_time = time.time() - time_start2

    print(f"My PSO: {my_results}, execution_time: {my_pso_time}")
    print(f"Pyswarm PSO: {pyswarm_results}, execution_time: {pyswarm_pso_time}")